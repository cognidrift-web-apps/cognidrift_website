    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-neutral-offWhite">
        <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* Table Header */}
            <div className="hidden md:grid grid-cols-6 gap-0 bg-primary-600 text-white font-bold text-sm">
            ...
            {universalFeatures.map((feature, index) => (
              <div
                key={index}
                className={`grid grid-cols-1 md:grid-cols-6 gap-0 border-t border-neutral-border ${
