...
const AiCrm = () => {
  ...
  const benefits = [
    { icon: Zap, text: 'Zero manual data entry required' },
    { icon: Globe, text: 'Syncs with Salesforce, HubSpot, and more' },
    { icon: FileText, text: 'AI-generated call summaries and action items' },
    { icon: Database, text: 'Custom fields and pipeline stages' },
    { icon: Users, text: 'Team collaboration with shared notes' },
    { icon: BarChart3, text: 'Export reports in one click' }
  ]
  ...
  const stats = [
    ...
    { value: '24/7', label: 'Auto-Logging' }
  ]

  const useCases = [
    {
      title: 'Sales Teams',
      description: 'Track every interaction, score leads automatically, and never miss a follow-up opportunity.',
      features: ['Lead scoring', 'Activity tracking', 'Deal pipeline']
    },
    {
      title: 'Customer Support',
      description: 'Access complete customer history instantly to provide personalized, context-aware support.',
      features: ['Ticket history', 'Customer 360 view', 'Escalation tracking']
    },
    {
      title: 'Marketing Teams',
      description: 'Segment contacts, track campaign responses, and measure ROI across all channels.',
      features: ['Campaign tracking', 'Segmentation', 'Attribution']
    },
    {
      title: 'Operations',
      description: 'Automate workflows, sync data across tools, and maintain clean, accurate records.',
      features: ['Workflow automation', 'Data sync', 'Deduplication']
    }
  ]
      ...
      <section className="pt-24 sm:pt-28 lg:pt-32 pb-16 sm:pb-20 bg-white">
        <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <Database className="w-10 h-10 sm:w-12 sm:h-12 text-blue-600" />
            </motion.div>

            {/* Title */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-text-primary mb-4 sm:mb-6">
              AI <span className="text-blue-600">CRM</span>
            </h1>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-neutral-offWhite">
        <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-text-secondary max-w-2xl mx-auto">
              CRM solutions for every department
            </p>
          </motion.div>
        ...
        <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="text-center mb-10 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-text-primary mb-4">
                Why Teams Choose Our <span className="text-blue-600">AI CRM</span>
              </h2>
              <p className="text-base sm:text-lg text-text-secondary max-w-2xl mx-auto">
        ...
        <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-text-primary mb-4 sm:mb-6 relative z-10">
              Ready to <span className="bg-gradient-to-r from-primary-500 to-blue-600 bg-clip-text text-transparent">Supercharge Your CRM?</span>
            </h2>
            <p className="text-base sm:text-lg text-text-secondary max-w-2xl mx-auto mb-8 relative z-10">
              Join businesses that capture and convert every lead with AI.
            </p>
