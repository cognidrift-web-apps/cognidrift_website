...
function RetellChatWidget() {
  ...
  useEffect(() => {
    ...
    script.setAttribute('data-title', '') // Empty title so we can use logo instead
    script.setAttribute('data-bot-name', 'CogniDrift Assistant')
    script.setAttribute('data-color', '#06B6D4') // Electrolytic blue (cyan)
    script.setAttribute('data-logo-url', 'https://cognidrift-agent.vercel.app/cognidrift_logo.png') // Custom CogniDrift logo for header
  ...
  const injectCustomStyles = () => {
    ...
    style.textContent = `
      ...
      [data-retell-widget] .chat-header h1,
      [data-retell-widget] .chat-header .title {
        display: none !important;
      }

      [data-retell-widget] .chat-header::before {
        content: '' !important;
        display: block !important;
        width: 120px !important;
        height: 40px !important;
        background-image: url('https://cognidrift-agent.vercel.app/cognidrift_logo.png') !important;
